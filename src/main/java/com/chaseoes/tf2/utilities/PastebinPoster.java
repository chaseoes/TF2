    ...
    private static class PasteProcessor implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                out.write(("api_option=paste" + "&api_dev_key=" + URLEncoder.encode("a60ea54996e6584f420dfa9d948448d9", "utf-8") + "&api_paste_code=" + URLEncoder.encode(code, "utf-8") + "&api_paste_private=" + URLEncoder.encode("0", "utf-8") + "&api_paste_name=" + URLEncoder.encode("", "utf-8") + "&api_paste_expire_date=" + URLEncoder.encode("1D", "utf-8") + "&api_paste_format=" + URLEncoder.encode("text", "utf-8") + "&api_user_key=" + URLEncoder.encode("", "utf-8")).getBytes());
                out.flush();
                out.close();
